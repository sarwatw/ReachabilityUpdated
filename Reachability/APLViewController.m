...
- (void)viewDidLoad
{
     ...
     */
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reachabilityChanged:) name:kMSReachabilityChangedNotification object:nil];
...
- (void)dealloc
{
    [[NSNotificationCenter defaultCenter] removeObserver:self name:kMSReachabilityChangedNotification object:nil];
}
